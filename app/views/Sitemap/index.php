...
while($row = mysqli_fetch_array($result)){
	...
	echo '<link xmlns:xhtml="http://www.w3.org/1999/xhtml" rel="alternate" hreflang="'.$row["alternate_first"].'" href="'.$base_url.$row["alternate_first"].$row["page_url"].'"></link>'.PHP_EOL;
	echo '<link xmlns:xhtml="http://www.w3.org/1999/xhtml" rel="alternate" hreflang="'.$row["alternate_second"].'" href="'.$base_url.$row["alternate_second"].$row["page_url"].'"></link>'.PHP_EOL;
